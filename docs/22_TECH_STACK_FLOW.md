...
| **Zero Feasible Products** | Hard constraints collide across group | Scoring engine catches empty candidate set, executes **Relaxation Branching**, identifies the conflicting constraint pair, and outputs top compromises with explicit conflict banners. |
